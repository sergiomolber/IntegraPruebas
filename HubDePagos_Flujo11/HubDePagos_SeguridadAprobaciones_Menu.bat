...
echo ================================================================================
echo                                     BIENVENIDO
echo                            HUBDEPAGOS_SEGURIDAD APROBACIONES
echo                           %DATE% ^| %TIME%
echo.
echo ================================================================================

echo  1    Aprobar transacciones
...
:op1
    ...
    echo.
      gradle clean test --tests *com.integra.ach.runners.AprobacionesTransaccionesRunner aggregate & cd target/site/serenity & index.html
